...
def generate_routine_algorithm(department_id, semester_id=None, ignore_warnings=False):
    ...
    class DefaultConfig:
        parallel_bonus = 100000       #  Mega Magnet for perfectly parallel classes
        edge_slot_penalty = 8000      # Huge penalty for first & last slots
        zero_gap_bonus = 3000
        gap_penalty_per_slot = 1500
        center_gravity_bonus = 3000   # Pulls everyone to the middle
        continuous_class_penalty = 500
        day_load_penalty_multiplier = 500 # Exponential Day Load base multiplier
        ...
        for session in all_sessions:
            ...
            for day in sorted_days:
                ...
                for i in range(len(time_slots) - duration + 1):
                    ...
                    #  Exponential Day Load Penalty (Perfect Averaging Without Dropping)
                    ...
                    # Universal Center Gravity & Edge Penalty (Applied to ALL Phases)
