...
- **Student Routine Module**: 
  - [student-routine/index.tsx](file:///c:/Users/Shuvo%20Debnath/VsCode/University%20Project%20Frontend/Frontend/src/components/modules/dashboard/student-routine/index.tsx) *(Reduced break text size & removed utensils)*
- **Teacher Own Routine Module**:
  - [own-routine/index.tsx](file:///c:/Users/Shuvo%20Debnath/VsCode/University%20Project%20Frontend/Frontend/src/components/modules/dashboard/own-routine/index.tsx) *(Reduced break text, removed utensils, converted style scope to jsx global, fully synced print CSS & container wrapper classes)*
- **Admin/Entries Routine Module**:
  - [routine-entries/index.tsx](file:///c:/Users/Shuvo%20Debnath/VsCode/University%20Project%20Frontend/Frontend/src/components/modules/dashboard/routine-entries/index.tsx) *(Converted style scope to jsx global, synced print CSS & container wrapper classes)*
